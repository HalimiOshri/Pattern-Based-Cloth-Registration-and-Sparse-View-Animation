...
if __name__ == '__main__':
    ...
    save_dir = '/mnt/home/oshrihalimi/cloth_completion/data_processing/posedLBS_pixel_location_uv/'

    camera_image_width = 2668
    camera_image_height = 4096
    rendering_scale = 1.0
    posedLBS_path = '/mnt/home/oshrihalimi/cloth_completion/data_processing/s--20210823--1323--0000000--pilot--patternCloth/posedLBS/'
    ...
    for frame in os.listdir(posedLBS_path):
